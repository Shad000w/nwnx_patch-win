...
struct CGameObject_VTable_s {
	...
	int							(*GetEffectSpellId)(void *);											/* BC */
	int							(*SetLockOrientationToObject)(void *, uint32_t);						/* C0 */
	uint32_t					(*GetLockOrientationToObject)(void *);									/* C4 */
	void *						(*GetPortrait)(void *, void *);											/* C8 */
	void *						(*SetPortrait)(void *);													/* CC */
	int16_t						(*GetPortraitId)(void *);												/* D0 */
	void						(*SetPortraitId)(void *, uint16_t);										/* D4 */
	void						(*BroadcastFloatyData)(void *, CNWCCMessageData*);						/* D8 */
	void						(*BroadcastFloatyDataSTRREF)(void *, uint32_t);							/* DC */
	void						(*UpdateEffectPtrs)(void *);											/* E0 */
	void						(*UpdateAttributesOnEffect)(void *, CGameEffect*, int32_t);				/* E4 */
};
