...
void			(__thiscall *CGameEffect__SetInteger)(CGameEffect *pTHIS, int nTh, int iVal) = (void(__thiscall*)(CGameEffect *pTHIS, int nTh, int iVal))0x4E8140;
...
void CGameEffect_s::SetInteger(int nTh, int iVal)
{
return CGameEffect__SetInteger(this,nTh,iVal);
}