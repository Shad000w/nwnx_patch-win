...
int (__thiscall *CVirtualMachine__StackPopObject)(CVirtualMachine *pTHIS, unsigned long *oID) = (int(__thiscall*)(CVirtualMachine *pTHIS, unsigned long *oID))0x005C09C0;
...
int CVirtualMachine_s::StackPopObject(unsigned long *oID) {
