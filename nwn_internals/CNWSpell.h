...
struct CNWSpell_s {
  ...
  unsigned __int8 field_0F4;//Proj?
  ...
  unsigned __int32 UserType;
  unsigned __int32 SpontaneouslyCast;//0x148
  unsigned __int32 Metamagic;
  unsigned __int32 AltMessage;
  unsigned __int32 HostileSetting;
  unsigned __int32 FeatId;
  unsigned __int32 HasProjectile;
