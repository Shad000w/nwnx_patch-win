...
int						(__thiscall *CServerExoAppInternal__GetPlayerLanguage)(CServerExoAppInternal* pTHIS, unsigned long oID) = (int (__thiscall*)(CServerExoAppInternal* pTHIS, unsigned long oID))0x80B0724;
