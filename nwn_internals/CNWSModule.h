...
struct CNWSModule_s {
    ...
    uint32_t                    field_40;
    uint32_t                    field_44;
    CExoLinkedList              mod_PlayerTURDList; /* 0x48 */

	char rsvd1[8];								/* 0x58/88 */
	CExoString					m_sCustomTLK;	/* 0x58/88 */
	char rsvd2[32];								/* 0x80/128 */
    uint32_t field_80;
    uint32_t field_84;
	uint32_t field_88;
    //CNWSScriptVarTable          mod_vartable;	/* 0x0088 */
    CExoArrayList_string	    HakList;		/* 0x8C/140 */
	char rsvd3[32];								/* 0xB8/184 */
