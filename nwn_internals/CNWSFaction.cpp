...
void 			(__thiscall *CNWSFaction__SendChatMessage)(CNWSFaction *pThis, nwn_objid_t Sender_oID, CExoString Msg) = (void(__thiscall*)(CNWSFaction *, nwn_objid_t, CExoString))0x4E99A0;
