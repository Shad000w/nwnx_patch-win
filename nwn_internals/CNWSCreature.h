...
//	uint32_t 								cre_minimapcount;	/* 0x049C */
	...
	uint8_t									field_9DE;
	uint8_t									field_9DF;
	uint8_t									field_9E0;//possibly spell id
	uint8_t									field_9E1;
	uint8_t									field_9E2;
	uint8_t									field_9E3;
	uint8_t									field_9E4;
	...
	uint32_t 							cre_associate_type;
	uint32_t 								cre_associate_command;
	uint32_t 								cre_summoned_acomp;
	uint32_t 								cre_summoned_famil;
	uint8_t 								field_B48;
	uint8_t 								field_B49;
	uint8_t 								field_B4A;
	uint8_t 								field_B4B;
	...
	uint32_t							cre_total_weight;					/* 0x0B8C */
  	...
  	//uint8_t 							spacer5_141;/* 0x0C1C */
  	//uint8_t 							spacer5_142;/* 0x0C1D */
  	//uint8_t 							spacer5_143;/* 0x0C1E */
  	//uint8_t 							spacer5_144;/* 0x0C1F */
    uint32_t						cre_is_polymorphing; /* 0C20 */
    uint32_t						cre_poly_locked; /* 0C24 */
  	CNWSCreatureAppearanceInfo		cre_appearance_info;
	/*uint8_t 							spacer5_150;// 0x0C25 
  	uint8_t 							spacer5_151;// 0x0C26 
  	uint8_t 							spacer5_152;// 0x0C27 
  	uint8_t 							spacer5_153;// 0x0C28 
  	uint8_t 							spacer5_154;// 0x0C29 
  	uint8_t 							spacer5_155;// 0x0C2A 
  	uint8_t 							spacer5_156;// 0x0C2B 
  	uint8_t 							spacer5_157;// 0x0C2C 
	uint8_t 							spacer5_158;// 0x0C2D 
  	uint8_t 							spacer5_159;// 0x0C2E 
  	uint8_t 							spacer5_160;// 0x0C2F 
  	uint8_t 							spacer5_161;// 0x0C30 
  	uint8_t 							spacer5_162;// 0x0C31 
  	uint8_t 							spacer5_163;// 0x0C32 
  	uint8_t 							spacer5_164;// 0x0C33 
  	uint8_t 							spacer5_165;// 0x0C34 
  	uint8_t 							spacer5_166;// 0x0C35 
  	uint8_t 							spacer5_167;// 0x0C36 
  	uint8_t 							spacer5_168;// 0x0C37 
  	uint32_t 						cre_appearance;// 0x0C38 
  	uint8_t 							spacer01;// 0x0C3C 
  	uint8_t 							spacer02;// 0x0C3D 
  	uint8_t 							spacer03;// 0x0C3E 
  	uint8_t 							spacer04;// 0x0C3F 
  	uint8_t 							spacer05;// 0x0C40 
  	uint8_t 							spacer06;// 0x0C41 
  	uint8_t 							spacer07;// 0x0C42 
  	uint8_t 							spacer08;
  	uint8_t 							spacer09;
  	uint8_t 							spacer10;
  	uint8_t 							spacer11;
  	...
  	uint8_t 							spacer35;
  	uint8_t 							spacer36;
  	uint8_t 							spacer37;// 0x0C60 
  	uint8_t 							spacer38;// 0x0C61 
  	uint8_t 							spacer39;// 0x0C62 
  	uint8_t 							spacer40;// 0x0C63 */
	...
	void				PossessCreature(CNWSCreature *pTHIS, nwn_objid_t oidPossessee);
	void 				PostProcess();
	...
	void				SummonAssociate(CResRef ResRef, char *Name, uint32_t len, uint16_t Type);
