...
struct CServerExoAppInternal_s {
	...
	CServerExoAppConfig		*ServerInfo;			/* 1000C */
	...
	CNWSPlayer*				GetClientObjectByObjectId(unsigned long id);
	CNWSPlayer* GetClientObjectByPlayerId(unsigned long id, unsigned char a2);
	int						GetSetMaxLevel( int nMaxLevel );
	int						GetPlayerLanguage(unsigned long oID);
